        ...
        <div className="pt-16 pb-16 bg-[#050709]">
         ...
         className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20">
            ...
            className=" grid grid-cols-2 gap-16 items-center lg:mx-auto">
                {/* 1st state */}
                <div>
                    <Image src="/images/customer.png" alt="img" width={80} height={80}
                    className="mx-auto"/>
                ...
                {/* 2nd state */}
                <div>
                    <Image src="/images/experience.png" alt="img" width={80} height={80}
                    className="mx-auto"/>
                    <p className="mt-3 font-bold text-xl text-white text-center">
                        {aboutInfo.experience}</p>
                    <p className="text-base sm:text-lg text-gray-400 text-center">
                        Years Experience</p>
                </div>
                {/* 3rd state */}
                <div>
                    <Image src="/images/completed.png" alt="img" width={80} height={80}
                    className="mx-auto"/>
                    <p className="mt-3 font-bold text-xl text-white text-center">
                        {aboutInfo.project}</p>
                    <p className="text-base sm:text-lg text-gray-400 text-center">
                ...
                {/* 4th state */}
                <div>
                    <Image src="/images/rocket.png" alt="img" width={80} height={80}
                    className="mx-auto"/>
                    <p className="mt-3 font-bold text-xl text-white text-center">
                        {aboutInfo.website}</p>
                    <p className="text-base sm:text-lg text-gray-400 text-center">
